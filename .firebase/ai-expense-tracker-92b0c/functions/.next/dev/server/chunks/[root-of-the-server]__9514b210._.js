...
"[project]/src/app/api/generate-insights/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!expenses || expenses.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                tips: [
                    "Record some expenses to get insights!"
                ]
            });
        }
        const expensesSummary = expenses.map((e)=>`${e.date}: $${e.amount} at ${e.vendor} (${e.category})`).join("\n");
...
${expensesSummary}`;
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                tips: [
                    "Keep track of your spending patterns to find savings."
                ]
            });
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9514b210._.js.map