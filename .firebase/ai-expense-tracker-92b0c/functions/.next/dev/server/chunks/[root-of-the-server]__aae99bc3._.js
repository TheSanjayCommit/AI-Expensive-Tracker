...
"[project]/src/app/api/get-expenses/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const snapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].collection("expenses").orderBy("createdAt", "desc").get();
        const expenses = [];
        snapshot.forEach((doc)=>{
            // Convert timestamps to string/Date for client
            const data = doc.data();
            expenses.push({
                id: doc.id,
                ...data,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: error.message || "Failed to load expenses securely"
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aae99bc3._.js.map