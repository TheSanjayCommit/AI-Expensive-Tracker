    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchInitialLogs = async ()=>{
            try {
                ...
                if (!res.ok) throw new Error("Failed connecting to Firebase Admin API");
                const data = await res.json();
    ...
    const handleTranscript = async (transcript)=>{
        ...
        try {
            ...
            if (parsedData && parsedData.amount) {
                ...
                // 3. Save to Firebase via Admin API
                const saveRes = await fetch("/api/save-expense", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
                ...
                if (!saveRes.ok) {
                    ...
                    throw new Error(errData.error || "Missing or insufficient permissions.");
                }
                const savedExpenseData = await saveRes.json();
                // 4. Update UI State
                setExpenses((prev)=>[
                        savedExpenseData,
                        ...prev
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b00798a3._.js.map